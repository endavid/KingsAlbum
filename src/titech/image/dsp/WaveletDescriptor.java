...
/**
  * An <code>OperationDescriptor</code> describing the "Wavelet" operation.
  * <P> The "Wavelet" operation performs a tranformation over the image,
  * obtaining as a result a float image divided hierarchicly in subbands.
  * <p><table border=1>
  ...
  */
public class WaveletDescriptor extends OperationDescriptorImpl {

  private static final String[][] resources = {
     {"GlobalName", "Wavelet"},
     {"LocalName",  "Wavelet"},
     {"Description", "Does the wavelet transformation on a image."},
     {"DocURL",      "WaveletDescriptor.html"},
     {"Version",     "0.0"},
  ...
  private static final Vector algorithms = validAlgorism();
  
  public WaveletDescriptor() {
  ...
  private static Vector validAlgorism() {
    Vector v = new Vector();
    v.add("shore");
    v.add("haar");
    return v;
